...
@Ignore
public class PodLogsActionTest {

    @Test
    public void test() throws Exception{
        var kubeconfig = Path.of(Objects.requireNonNull(System.getenv("KUBECONFIG")));

        var action = new PodLogsAction();
        var params = new K8sTaskParams.PodLogsParams(new K8sTaskParams.BaseParams(kubeconfig), "brig", "webapp-6fdc49b488-vkmp9", true, true, 100);
