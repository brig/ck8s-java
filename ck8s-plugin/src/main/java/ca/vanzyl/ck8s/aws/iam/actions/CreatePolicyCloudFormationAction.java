...
public class CreatePolicyCloudFormationAction extends IamTaskAction<CreatePolicyParams> {

    private final IamState state;

    @Inject
    public CreatePolicyCloudFormationAction(IamClientFactory clientFactory, IamState state) {
        super(clientFactory);
        this.state = state;
    }
