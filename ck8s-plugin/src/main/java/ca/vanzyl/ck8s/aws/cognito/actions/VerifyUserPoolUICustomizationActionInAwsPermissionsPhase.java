...
public class VerifyUserPoolUICustomizationActionInAwsPermissionsPhase extends CognitoTaskAction<CognitoTaskParams.CreateUserPoolUICustomizationParams> {

    private final CloudFormation cloudFormation;

    @Inject
    public VerifyUserPoolUICustomizationActionInAwsPermissionsPhase(CognitoClientFactory clientFactory,
    ...
    public TaskResult execute(Context context, CognitoTaskParams.CreateUserPoolUICustomizationParams input) throws Exception {
        ...
        cloudFormation.statement(new Statement(
                Statement.ALLOW,
                Set.of("cognito-idp:GetUICustomization"),
