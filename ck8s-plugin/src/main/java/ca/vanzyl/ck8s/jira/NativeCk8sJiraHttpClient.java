...
public class NativeCk8sJiraHttpClient implements Ck8sJiraHttpClient {
    ...
    public NativeCk8sJiraHttpClient(JiraClientCfg cfg) {
        this.cfg = cfg;
    ...
    @Override
    public Ck8sJiraHttpClient url(String url) {
        this.url = URI.create(url);
        return this;
    }

    @Override
    public Ck8sJiraHttpClient successCode(int successCode) {
        this.successCode = successCode;
        return this;
    }

    @Override
    public Ck8sJiraHttpClient jiraAuth(String auth) {
        this.auth = auth;
        return this;
    }
    ...
    public List<Map<String, Object>> getList() throws IOException {
        ...
        return call(request, LIST_OF_MAPS_TYPE);
    }
    ...
    <T> T call(HttpRequest request, JavaType returnType) throws IOException {
        try {
            ...
            Ck8sJiraHttpClient.assertResponse(statusCode, results, successCode);
